...
const threadsController = __importStar(require("../controllers/threadsController"));
...
threadsRouter.get("/userLogin", authentication_1.default, threadsController.threadsAllbyUserLogin);
...
threadsRouter.post("/", uploads_1.upload.any(), authentication_1.default, threadsController.threadsCreate);
